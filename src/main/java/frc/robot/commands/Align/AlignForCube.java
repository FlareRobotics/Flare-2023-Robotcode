...
public class AlignForCube extends CommandBase {
  ...
  public AlignForCube(DriveSubsystem driveSubsystem) {
  ...
  public void initialize() {
    ...
    // System.out.println("AUTO Align Cube Start");
  ...
  public void execute() {
    ...
    if (!DriveSubsystem.turn_angles(needed_angle, gyro_aci, target_y < 0))
      return;
    ...
    if (!DriveSubsystem.turn_angles(gyro_aci, needed_angle, !(target_y < 0)))
      return;
  ...
  public void end(boolean interrupted) {
    // System.out.println("AUTO Align Cube End");
  }
