...
public class ElevatorSubsystem extends SubsystemBase {
  ...
  public ElevatorSubsystem() {
       ...
       elevator_motor.selectProfileSlot(PidConstants.TurretConstants.kSlotIdx, PidConstants.TurretConstants.kPIDLoopIdx);
  ...
  public static int elevator_yukseklik_cm(){
        return (int)(Math.round(elevator_motor.getSelectedSensorPosition() /2048 /ElevatorConstants.elevator_gear_ratio * ElevatorConstants.elevator_distance_per_rotation));
  }
  //cm to Units
  public static int elevator_yukseklik_units(int cm){
        return (int)(2048*ElevatorConstants.elevator_gear_ratio*cm/ElevatorConstants.elevator_distance_per_rotation);
}
